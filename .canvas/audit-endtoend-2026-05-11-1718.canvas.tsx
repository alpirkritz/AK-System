...
const STATE: RunState = {
  "title": "AK System weekly audit — endtoend-2026-05-11-1718",
  "startedAt": 1778509114986,
  "tasks": [
    {
      "id": "lint",
      "depends_on": [],
      ...
      "status": "ERROR",
      "model": "auto-low",
      "startedAt": 1778509114988,
      "errorMessage": "Runner terminated",
      "finishedAt": 1778509116798,
      "durationMs": 1810
    },
    {
      "id": "typecheck-build",
  ...
  "runOutcome": "FAILED",
  "runMessage": "Runner failed: Cannot use this model: auto-low. Available models: default, composer-2, gpt-5.5, gpt-5.3-codex, claude-sonnet-4-6, claude-opus-4-7, grok-4.3, gpt-5.4, claude-opus-4-6, claude-opus-4-5, gpt-5.2, gemini-3.1-pro, gpt-5.4-mini, gpt-5.4-nano, claude-haiku-4-5, gpt-5.3-codex-spark, claude-sonnet-4-5, gpt-5.2-codex, gpt-5.1-codex-max, gpt-5.1, gemini-3-flash, gpt-5.1-codex-mini, claude-sonnet-4, gpt-5-mini, gemini-2.5-flash, kimi-k2.5. Use Cursor.models.list() to discover valid selections.",
  "finishedAt": 1778509116798
};
